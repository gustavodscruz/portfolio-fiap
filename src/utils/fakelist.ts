...
export const autores = ["Gustavo Dias", "Júlia Monteiro", "Júlia Angelozi", "Felipe Ribeiro", "Sofia Petruk"] as const
export type Autor = typeof autores[number]

export const tiposTarefa = ["Challenge", "Global Solution", "Checkpoints"] as const
