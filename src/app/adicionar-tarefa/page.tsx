...
const AdicionarTarefa = () => {
  ...
  return (
    <div className='bg-[#011625] rounded-xl p-6 flex flex-col gap-4 m-auto'>
        ...
        <input type="text"  name="titulo" id="titulo" placeholder='Digite o título' className=' p-2 rounded-sm outline-none text-[#000]' />
        <label className='text-xl text-primary-text font-semibold flex gap-2 items-center' htmlFor="">
          <MdPerson size={20} color='#ec4899' />
          Autor
        </label>
        <select required className='p-2 outline-none rounded-sm ' name="" id="">
        ...
        <fieldset className="flex gap-4 py-2 flex-col">
          ...
          <div className="flex gap-4">
            ...
            <div className="flex gap-2">
              <input type="radio" name="semestre" className='text-primary-text' value={"1º Semestre"} id="semestreChoice1" />
              <label htmlFor="semestreChoice1" className='text-white'>
                1º Semestre
              </label>
            </div>
            <div className="flex gap-2">
              <input type="radio" name="semestre" className='text-primary-text' value={"2º Semestre"} id="semestreChoice2" />
        ...
        <textarea name="inputDescricao" id="" cols={30} rows={5} placeholder='Descreva a tarefa ' className='p-3 outline-none text-black rounded-sm'></textarea>
        <label htmlFor="nota" className='text-primary-text text-xl flex gap-2 items-center'>
          <MdNote size={20} color='#ec4899' />
          Nota
        </label>
        <input type="number" min={0} max={100} name="nota" id="nota" placeholder='Nota' className=' p-2 rounded-sm text-lg text-gray-500 tracking-wide outline-none' />
        <label htmlFor="inputFeedback" className='text-primary-text text-xl flex gap-2 items-center'>
          <MdFeedback size={20} color='#ec4899'/>
          Feedback
        </label>
        <textarea name="inputFeedback" id="inputFeedback" cols={30} rows={5} placeholder='Feedback do professor ' className='p-3 outline-none text-black rounded-sm'></textarea>
