    ...
    return (
        <footer className="p-4 flex">
            ...
            <form className="flex flex-col items-start w-1/3 m-auto gap-5 pt-5">
                <input type="text" className="w-full p-4 rounded-md" placeholder="Name" />
                <input type="email" className="w-full p-4 rounded-md" placeholder="Email" />
                <button className="py-3 px-5 bg-red-custom w-1/2 rounded-md">Submit</button>
            </form>
        </footer>
    )
}