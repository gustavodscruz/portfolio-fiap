...
export default function Card({nome, resumo, foto, github, linkedin}: CardMembro){
    return(
        <>
        <div className="flex flex-col bg-[#1B1616] rounded-md w-[300px] m-auto items-center min-h-[500px]">
            <Image src={foto ?? "/devs.png"} alt={`Foto dev ${nome}`} height={200} width={300} className=" rounded-t-lg h-[200px] w-[300px] object-cover object-center"  />
